...
const TrendsformationCard = ({ item, onClick, type, index }) => {
  ...
  return (
    ...
    >
      ...
      <Skeleton loading={isLoading} w="108px" h="120px">
        {!isLoading && (
          <Image
            src={fetchedData}
            alt="Trend"
      ...
      <Text fontSize="12px" fontWeight="800" color="black" textAlign="left">
        {item.name}
      </Text>
    </VStack>
  );
